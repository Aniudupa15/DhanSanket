...
_IndexQuoteDto _$IndexQuoteDtoFromJson(Map<String, dynamic> json) => _IndexQuoteDto(
...
Map<String, dynamic> _$IndexQuoteDtoToJson(_IndexQuoteDto instance) => <String, dynamic>{
