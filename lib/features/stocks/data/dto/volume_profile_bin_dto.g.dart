...
_VolumeProfileBinDto _$VolumeProfileBinDtoFromJson(Map<String, dynamic> json) =>
    _VolumeProfileBinDto(
      priceLow: const DecimalConverter().fromJson(json['price_low'] as String),
      priceHigh: const DecimalConverter().fromJson(
        json['price_high'] as String,
      ),
      volume: (json['volume'] as num).toInt(),
    );

Map<String, dynamic> _$VolumeProfileBinDtoToJson(
  _VolumeProfileBinDto instance,
) => <String, dynamic>{
