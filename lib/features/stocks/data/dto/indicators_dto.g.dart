...
_IndicatorsDto _$IndicatorsDtoFromJson(
  ...
  macd: json['macd'] == null
      ? null
      : MacdDto.fromJson(json['macd'] as Map<String, dynamic>),
  bollinger: json['bollinger'] == null
      ? null
      : BollingerDto.fromJson(json['bollinger'] as Map<String, dynamic>),
  ...
  supertrend: json['supertrend'] == null
      ? null
      : SupertrendDto.fromJson(json['supertrend'] as Map<String, dynamic>),
  ...
  pointOfControl: json['point_of_control'] == null
      ? null
      : VolumeProfileBinDto.fromJson(
          json['point_of_control'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$IndicatorsDtoToJson(_IndicatorsDto instance) =>
    <String, dynamic>{
