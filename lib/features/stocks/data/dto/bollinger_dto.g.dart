...
_BollingerDto _$BollingerDtoFromJson(Map<String, dynamic> json) => _BollingerDto(
...
Map<String, dynamic> _$BollingerDtoToJson(_BollingerDto instance) => <String, dynamic>{
