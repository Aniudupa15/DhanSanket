...
_StockDetailDto _$StockDetailDtoFromJson(Map<String, dynamic> json) => _StockDetailDto(
  ...
  instrumentType: $enumDecode(_$InstrumentTypeDtoEnumMap, json['instrument_type']),
  listingDate: json['listing_date'] == null ? null : DateTime.parse(json['listing_date'] as String),
  faceValue: const NullableDecimalConverter().fromJson(json['face_value'] as String?),
  quote: json['quote'] == null ? null : QuoteDto.fromJson(json['quote'] as Map<String, dynamic>),
  quoteUnavailableReason: json['quote_unavailable_reason'] as String?,
);

Map<String, dynamic> _$StockDetailDtoToJson(_StockDetailDto instance) => <String, dynamic>{
