...
_CorporateActionDto _$CorporateActionDtoFromJson(Map<String, dynamic> json) =>
    _CorporateActionDto(
      purpose: json['purpose'] as String,
      faceValue: const NullableDecimalConverter().fromJson(
        json['face_value'] as String?,
      ),
      exDate: json['ex_date'] == null
          ? null
          : DateTime.parse(json['ex_date'] as String),
      recordDate: json['record_date'] == null
          ? null
          : DateTime.parse(json['record_date'] as String),
      bookClosureStart: json['book_closure_start'] == null
          ? null
          : DateTime.parse(json['book_closure_start'] as String),
      bookClosureEnd: json['book_closure_end'] == null
          ? null
          : DateTime.parse(json['book_closure_end'] as String),
    );

Map<String, dynamic> _$CorporateActionDtoToJson(_CorporateActionDto instance) =>
    <String, dynamic>{
