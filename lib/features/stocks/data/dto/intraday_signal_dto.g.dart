...
_IntradaySignalDto _$IntradaySignalDtoFromJson(
  ...
  entryPrice: const NullableDecimalConverter().fromJson(
    json['entry_price'] as String?,
  ),
  targetPrice: const NullableDecimalConverter().fromJson(
    json['target_price'] as String?,
  ),
  stopLoss: const NullableDecimalConverter().fromJson(
    json['stop_loss'] as String?,
  ),
  riskRewardRatio: const NullableDecimalConverter().fromJson(
    json['risk_reward_ratio'] as String?,
  ),
  probability: const NullableDecimalConverter().fromJson(
    json['probability'] as String?,
  ),
  reasoning:
...
Map<String, dynamic> _$IntradaySignalDtoToJson(
  _IntradaySignalDto instance,
) => <String, dynamic>{
  ...
  'risk_reward_ratio': const NullableDecimalConverter().toJson(
    instance.riskRewardRatio,
  ),
