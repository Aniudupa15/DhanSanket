...
_PivotPointsDto _$PivotPointsDtoFromJson(Map<String, dynamic> json) => _PivotPointsDto(
...
Map<String, dynamic> _$PivotPointsDtoToJson(_PivotPointsDto instance) => <String, dynamic>{
