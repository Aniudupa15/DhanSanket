...
_ScreenerResultDto _$ScreenerResultDtoFromJson(Map<String, dynamic> json) => _ScreenerResultDto(
...
Map<String, dynamic> _$ScreenerResultDtoToJson(_ScreenerResultDto instance) => <String, dynamic>{
