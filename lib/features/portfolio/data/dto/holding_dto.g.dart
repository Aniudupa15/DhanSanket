...
_HoldingDto _$HoldingDtoFromJson(Map<String, dynamic> json) => _HoldingDto(
  ...
  currentPrice: const NullableDecimalConverter().fromJson(
    json['current_price'] as String?,
  ),
  currentValue: const NullableDecimalConverter().fromJson(
    json['current_value'] as String?,
  ),
  pnl: const NullableDecimalConverter().fromJson(json['pnl'] as String?),
  pnlPercent: const NullableDecimalConverter().fromJson(
    json['pnl_percent'] as String?,
  ),
);

Map<String, dynamic> _$HoldingDtoToJson(
  _HoldingDto instance,
) => <String, dynamic>{
  ...
  'current_price': const NullableDecimalConverter().toJson(
    instance.currentPrice,
  ),
  'current_value': const NullableDecimalConverter().toJson(
