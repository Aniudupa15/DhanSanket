...
_NewsArticleDto _$NewsArticleDtoFromJson(Map<String, dynamic> json) => _NewsArticleDto(
...
Map<String, dynamic> _$NewsArticleDtoToJson(_NewsArticleDto instance) => <String, dynamic>{
